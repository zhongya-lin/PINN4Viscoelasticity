...
if __name__ == '__main__':
    ...
    net_name = MODEL_PATH + 'Beam_HE_10-1_' + datetime.datetime.now().strftime('%Y-%m-%d-%H')
    ...
    relaxation_time = 0.0
    opti = Adam(pinn, x_train, y_train, relaxation_time, maxiter=44000, visco=False, net_name=net_name, learning_rate=5e-3)
    hist, his_loss = opti.fit()
    np.savetxt(net_name + '_loss' + '.csv', his_loss, delimiter=',')
