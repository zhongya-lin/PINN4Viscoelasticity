...
class Adam:
    def __init__(self, pinn, x_train, y_train, dx, dy, dt=0, learning_rate=0.001, maxiter=1500):
    ...
    def loss_grad(self, x, y):
        ...
        loss, l1, l2 = energy_loss(y_p, y, self.dx, self.dy)
...
def energy_loss(pred, ground, dx, dy):
    ### Internal potential energy and Potential energy of the external force
    l1 = dx * dy * torch.sum(pred[0])
    l2 = torch.sum(pred[1] * ground[6]) * dx
